...
namespace itemsjs {
  ...
  std::string index(const std::string& json_path, const std::string& json_string, const std::vector<std::string> faceted_fields, const std::vector<std::string> sorting_fields, bool append);
