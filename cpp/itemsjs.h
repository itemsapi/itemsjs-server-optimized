...
namespace itemsjs {
  ...
  std::tuple<std::string, std::optional<Roaring>> search_facets(nlohmann::json input, nlohmann::json filters_array, nlohmann::json conf, std::optional<Roaring> query_ids);
  std::string json();
